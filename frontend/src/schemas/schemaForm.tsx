...
export const schema = z.object({
    ...
    .refine((val) => /^\d+$/.test(val), "Debe contener solo números")
    .refine((val) => Number(val) > 0, "La edad debe ser un número positivo")
    .refine((val) => Number(val) < 130, "La edad no puede ser tan alta"),
